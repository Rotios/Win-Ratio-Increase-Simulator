...
async function simulate(simulation_id, original_stats, options) {
...
async function run_threads(num_simulations, original_stats, options) {
    const threads = []
...
async function handle_event(event) {
    ...
    const max_simulated_battles = total_battles * total_battles
